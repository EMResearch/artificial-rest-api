package ex.resource.exp.artificial.controller.n5mediumpdhide;
...
import org.autogenerated.rest.artificial.cs.n5mediumpdhide.*;
/** automatically created on 2020-01-14 */
public class ExternalEvoMasterController extends ExternalSutController {
  public ExternalEvoMasterController() {
    this(
        40100,
        "n5-medium-pd-hide/n5-medium-pd-hide-cs/target/n5-medium-pd-hide-sut.jar",
        12345,
        120);
  }
  ...
  public static void main(String[] args) {
    ...
    String jarLocation = "n5-medium-pd-hide/n5-medium-pd-hide-cs/target";
    if (args.length > 2) {
      jarLocation = args[2];
    }
    if (!jarLocation.endsWith(".jar")) {
      jarLocation += "/n5-medium-pd-hide-sut.jar";
    }
  ...
  private String dbUrl(boolean withP6Spy) {
    ...
    url += ":h2:tcp://localhost:" + dbPort + "/./temp/tmp_n5-medium-pd-hide-cs/testdb_" + dbPort;
  ...
  public String getPackagePrefixesToCover() {
    return "org.autogenerated.rest.artificial.cs.n5mediumpdhide.";
  }
